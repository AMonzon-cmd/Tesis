      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('ListadoClientes')}}">Listado de Clientes</a></li>
    ...
    <div class="col-12 p-0">
      <div class="card card-primary">
        <div class="card-header pb-0">
          <a class="float-right align-middle mt-1" href="{{route('ListadoClientes')}}"><i class="fas fa-arrow-alt-circle-left fa-lg"></i> Ir al listado</a>
          <input type="text" value="{{$usuario->IdUsuario}}"  id="idUsuario" hidden>   
        </div>
        <!-- /.card-header -->
        <div class="card-body">
          <input type="text" id="txtId" value="{{$usuario->id}}" hidden>
          <input type="text" id="urii" value="{{route('ModificacionCliente')}}" hidden>
          <div class="row">
        ...
        <form role="form" id="formularioNuevoCliente">
          ...
          <div id="pnlPieBotones" class="card-footer text-right">
            <a href="{{route('ListadoClientes')}}" class="btn btn-success m-auto col-12 col-md-6 col-xl-3">Volver</a>
